...
The playground includes example files with both problematic and fixed code:
- `playground/index.js` - Contains all rule violations
- `playground/index-fixed.js` - Shows correct implementations
